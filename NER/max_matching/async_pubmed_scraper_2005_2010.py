...
if __name__ == "__main__":
    ...
    parser.add_argument('--start', type=int, default=2005, help='Specify start year for publication date range to scrape. Default = 2016')
    parser.add_argument('--stop', type=int, default=2010, help='Specify stop year for publication date range to scrape. Default = 2021')
