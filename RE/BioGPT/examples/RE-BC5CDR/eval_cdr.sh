...
MODEL=checkpoint_avg_cgt.pt
#DATA_DIR=${PWD}/../../data/BC5CDR/relis-bin
DATA_DIR=../../data/BC5CDR/relis-bin
...
RELATION_FILE=/N/project/zhangclab/Pavi/KD-DocRE/RE/BioGPT/checkpoints/RE-BC5CDR-BioGPT
PRED_FILE=/N/project/zhangclab/Pavi/KD-DocRE/RE/BioGPT/checkpoints/RE-BC5CDR-BioGPT/generate_${MODEL}
GOLD_FILE=/N/project/zhangclab/Pavi/KD-DocRE/RE/BioGPT/data/BC5CDR/raw/CDR_Data/CDR.Corpus.v010516/CDR_TestSet.PubTator.txt
...
echo "Begin inferencing ${OLDPWD} using gold ${GOLD_FILE} and pred ${PRED_FILE}.detok.extracted.PubTator"
bash eval_relation.sh PubTator ${GOLD_FILE} ${PRED_FILE}.detok.extracted.PubTator
cd ${BIOGPT_FOLDER}
